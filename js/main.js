...
(function ($) {
    ...
    var clPreloader = function () {
        ...
        $WIN.on('load', function () {
            ...
            $("#loader-custom").fadeOut("slow", function () {
    ...
    function loadGoogleReviews() {
        ...
        $("#google-reviews").googlePlaces({
            placeId: 'ChIJvSU2Fh01K4gRO4RolzO6gBw'
            , render: ['reviews', 'address', 'phone', 'profileUrl']
            , min_rating: 4
            , max_rows: 5
            , schema: {
        ...
        function customLogic(r, reviews) {
            console.log(reviews);
            $(".review-item").addClass("item");
            $(".item").wrapAll("<div class='owl-carousel owl-theme'></div>");
            loadOwlCarousel();
        }

        $("#google-reviews").on('afterRender.googlePlaces', customLogic);
